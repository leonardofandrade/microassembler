    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('general', 'General'), ('account', 'Account'), ('assembly', 'Assembly'), ('components', 'Components'), ('payment', 'Payment')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('action', models.CharField(choices=[('create', 'Create'), ('update', 'Update'), ('delete', 'Delete'), ('login', 'Login'), ('logout', 'Logout'), ('approve', 'Approve'), ('reject', 'Reject'), ('assign', 'Assign'), ('complete', 'Complete')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.CharField(choices=[('general', 'General Inquiry'), ('support', 'Technical Support'), ('feedback', 'Feedback'), ('complaint', 'Complaint'), ('other', 'Other')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_frequency', models.CharField(choices=[('immediately', 'Immediately'), ('daily', 'Daily Digest'), ('weekly', 'Weekly Digest')], default='immediately', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['recipient', 'read', 'created_at'], name='core_notifi_recipie_c3d445_idx'), models.Index(fields=['related_object_type', 'related_object_id'], name='core_notifi_related_7c0660_idx')],
            },
        ),
    ]
